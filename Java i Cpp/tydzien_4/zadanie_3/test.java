                ...
                switch (args[0].charAt(i)) {
                    case 'o': {
                        try {
                            ...
                            if(n > 0) {
                                System.out.println("    Obwod = " + figura.Figury_1.KOLO.LiczObwod(n));
                                System.out.println("    Pole = " + figura.Figury_1.KOLO.LiczPole(n) + "\n");
                            }
                            else {
                    ...
                    case 'p': {
                        try {
                            ...
                            double n = Double.parseDouble(args[licznik - 1]);
                            if(n > 0) {
                                System.out.println("    Obwod = " + figura.Figury_1.PIECIOKAT.LiczObwod(n));
                                System.out.println("    Pole = " + figura.Figury_1.PIECIOKAT.LiczPole(n) + "\n");
                            }
                            else {
                    ...
                    case 's': {
                        try {
                            ...
                            double n = Double.parseDouble(args[licznik - 1]);
                            if(n > 0) {
                                System.out.println("    Obwod = " + figura.Figury_1.SZESCIOKAT.LiczObwod(n));
                                System.out.println("    Pole = " + figura.Figury_1.SZESCIOKAT.LiczPole(n) + "\n");
                            }
                            else {
                                System.out.println("    " + n + " - Nieprawdilowy bok\n");
                            }
                        ...
                        try {
                            ...
                            if(czy_dobry_c && n[4] < 180) {
                                if(n[0] == n[1] && n[0] == n[2] && n[0] == n[3]) {
                                    if(n[4] == 90) {
                                        System.out.println("    Obwod = " + figura.Figury_1.KWADRAT.LiczObwod(n[0]));
                                        System.out.println("    Pole = " + figura.Figury_1.KWADRAT.LiczPole(n[0]) + "\n");
                                    }
                                    else {
                                        System.out.println("    Obwod = " + figura.Figury_2.ROMB.LiczObwod(n[0], n[4]));
                                        System.out.println("    Pole = " + figura.Figury_2.ROMB.LiczObwod(n[0], n[4]) + "\n");
                                    }
                                }
                                else if(n[4] == 90 && ((n[0] == n[1] && n[2] == n[3]) || (n[0] == n[2] && n[1] == n[3]) || (n[0] == n[3] && n[2] == n[1]))) {
                                    if(n[0] != n[1]) {
                                        System.out.println("    Obwod = " + figura.Figury_2.PROSTOKAT.LiczObwod(n[0], n[1]));
                                        System.out.println("    Pole = " + figura.Figury_2.PROSTOKAT.LiczObwod(n[0], n[1]) + "\n");
                                    }
                                    else {
                                        System.out.println("    Obwod = " + figura.Figury_2.PROSTOKAT.LiczObwod(n[0], n[2]));
                                        System.out.println("    Pole = " + figura.Figury_2.PROSTOKAT.LiczObwod(n[0], n[2]) + "\n");
                                    }
                                }
                                else {
